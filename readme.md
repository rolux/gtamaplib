...
**NEW:** Check out the [gtamaplib-vc](https://github.com/rolux/gtamaplib-vc) project. This adds a global optimizer and a web-based UI to edit annotations and to navigate the triangulated world.
