...
class Billboards(Landmark):
    ...
    def __init__(self, billboards=[
        ...
        ("Mount Kalaga National Park 02 (Helicopter) (X)", "Billboard near Lake Leonida", ((-2466.303, 6228.071, 132.143), (-2463.572, 6214.340, 132.143), (-2463.572, 6214.340, 126.143), (-2466.303, 6228.071, 126.143))),
