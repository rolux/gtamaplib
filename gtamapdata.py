...
cameras = {
    ...
    "[L1/40] Backyard": ((-1952.000, -1959.400, 5.000), (-1951.700, -1957.500, 5.700), (119.600, -27.500, 0.000), (50.000, None), (1920, 1080)),
...
pixels = {
    ...
    "[S2/57] Ambrosia 02 (Panorama)": [
        ...
        ((1895, 862), "USSM Smokestack (8)"),
        ((1907, 890), "USSM Smokestack (9)"),
        ((1961, 885), "USSM Smokestack (10)"),
        ((1976.5, 864), "USSM Smokestack (11)"),
...
landmarks = {
    ...
    "Box in Backyard": (-1954.600, -1959.000, 4.000),
