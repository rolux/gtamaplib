...
cameras = {
    ...
    "[L1/43] Pool": ((-5325.300, 3473.200, 66.900), (-5327.700, 3476.600, 67.900), (209.000, -11.000, 0.000), (None, 49.600), (1920, 1036), "2022-09-06 17-13-34 [1709]"),
...
pixels = {
    ...
    "[L1/43] Pool": [
        ((368, 868), "Starlet Motel Pool (A)"),
        ((403.5, 799.5), "Starlet Motel Pool (B)"),
        ((571.5, 435), "Starlet Motel Pool (D)"),
        ((610, 433.5), "Starlet Motel Pool (C)"),
        ((727, 273), "Starlet Motel Parassol 2"),
        ((772.5, 89.5), "Radio Tower near Intersection 1 (C)"),
        ((1273, 191), "Starlet Motel Parassol 1"),
        ((1442, 170), "Billboard near Intersection (BC)"),
        ((1473.5, 160.5), "Billboard near Intersection (BN)"),
    ],
