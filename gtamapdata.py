...
cameras = {
    ...
    #"[S2/66] Mount Kalaga National Park 04 (Mountain Pass) (X)": (None, (-4750.000, 6000.000, 120.000), (156.447, -13.566, 0.000), (60.000, None), (3840, 2160), "Mount Kalaga National Park 04 [1]"),
...
pixels = {
    ...
    "[S2/56] Ambrosia 01 (Bikers)": [
        ...
        ((1913, 267), "Ambrosia Hill (D)"),
        ((2345, 415.5), "Ambrosia Hill (E)"),
        ((2865, 580), "Ambrosia Hill (F)"),
    ],
