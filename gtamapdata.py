...
cameras = {
    ...
    "[T2/29] Pier (Sea)": (None, (-2300.000, -5250.000, 3.000), (76.500, -0.500, 0.000), (75.000, None), (3840, 1728), "Trailer 2 [2494]"),
...
landmarks = {
    ...
    "Anchor island (S)": (-2605.430, -5233.184, 0.000),  # via Leonida Keys Postcard (X)
