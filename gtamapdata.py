...
cameras = {
    ...
    "[L1/1] Diner": ((-6191.800, 4526.900, 14.900), (-6192.000, 4526.000, 15.700), (330.000, -6.000, 0.000), (None, 34.200), (1920, 1080), "2021-03-23 09-58-52"),
    ...
    "[L1/3] Amphitheater": (None, (-350, -100, 8.0), (254.000, -12.500, 0.000), (60.000, None), (1920, 1028), "2021-07-09 15-18-02 [1]"),
    ...
    "[L1/4] Diner (W)": ((-6185.800, 4502.700, 14.300), (-6179.600, 4500.100, 16.600), (63.337, -7.836, 0.000), (None, 51.300), (1920, 1080), "2021-07-12 12-19-51 [5235]"),
    ...
    "[L1/4] Diner (E)": ((-6164.100, 4468.100, 14.800), (-6169.600, 4472.500, 16.800), (232.000, -5.810, 0.000), (None, 54.000), (1920, 1080), "2021-07-12 12-19-51 [5388]"),
    ...
    "[L1/8] Gas Station (Lucia)": ((-6319.500, 2749.100, 12.500), (-6319.100, 2748.300, 13.100), (359.830, -0.250, 0.000), (57.350, 34.200), (1920, 1080), "2021-11-05 11-09-23 [?]"),
    ...
    "[L1/11] Sidewalk (Lucia)": ((1931.500, 274.000, 3.200), (1931.700, 270.400, 5.800), (10.000, -20.000, 0.000), (None, 49.600), (1920, 1080), "2022-01-20 11-18-26 [?]"),
    ...
    "[L1/15] Glitch (A)": ((1410.700, 1371.600, 2.900), (1411.600, 1379.700, -58.500), (28.300, -14.397, 0.000), (None, 49.600), (1920, 1080), "2022-04-12 10-28-55 [?]"),
    ...
    "[L1/21] Metro (NE) (B)": ((-1553.500, -301.000, 19.800), (-1554.500, -302.100, 20.900), (305.704, -15.194, 0.000), (None, 49.600), (1920, 1020), "2022-05-13 08-48-26 [?]"),
    ...
    "[T1/20] Rooftop Party": (None, (1925.000, 1978.000, 106.782), (162.533, -7.500, 0.000), (58.500, 34.970), (3840, 2160), "Trailer 1 [1124]"),
    ...
    "[T1/44] U-Turn (NW)": (None, (-6288.000, 3358.000, 5.500), (62.000, -1.000, 0.000), (50.000, None), (3840, 2160), "Trailer 1 [2117]"),
    "[T1/44] U-Turn (NE)": (None, (-6288.000, 3358.000, 5.500), (340.500, -3.000, 0.000), (45.000, None), (3840, 2160), "Trailer 1 [2168]"),
    "[T1/46] Uncle Jack's": None,
    ...
    "[S2/51] Port Gellhorn 01 (Starlet Motel)": None,
    "[S2/53] Port Gellhorn 03 (Blue Pills)": None,
    "[S2/54] Port Gellhorn 04 (Delights)": None,
    "[S2/55] Port Gellhorn 05 (Camping)": None,
    ...
    "[S2/68] Mount Kalaga National Park 04 (Mountain Pass)": None,
...
pixels = {
    ...
    "[L1/4] Diner (N)": [
        ((721.5, 791), "Player"),
        ((527, 82), "536 Richard Jackson Blvd (SE)"),
    ...
    "[L1/4] Diner (W)": [
        ...
        ((561, 398), "Sunshine Skyway Bridge (N) (B)"),
        ...
        ((795, 399.5), "Bay (C)"),
        ((885, 721), "Player"),
        ((1857, 624), "536 Richard Jackson Blvd (SE) (B)"),
        ((1889, 334), "536 Richard Jackson Blvd (SE)"),
    ],
    "[L1/4] Car Wash": [
        # ((670, 450), "Pylon (77)"),
        ((685, 466), "Pylon (C)"),
    ...
    "[L1/8] Gas Station (Lucia)": [
        ...
        # ((106, 871), "Player"),
        ((546, 392), "Pylon (B)"),
        ((691, 525), "Unknown Building (Port Gellhorn) (W)"),
        ((807, 453), "Pylon (C)"),
        #((840, 458), "Pylon (77)"),
    ...
    "[T2/58] Explosion": [
        ((137, 252), "Unknown Mountain"),
    ],
    "[T2/59] Park (Mobile Phone)": [
        ((1084, 463), "Billboard #1 (Port VC)"),
    ],
    "[T2/67] Television": [
...
landmarks = {
    ...
    "Bay (A)": (-6574.376, 4621.114, 0.000),  # via Diner (W)
    "Bay (B)": (-6570.172, 4629.487, 0.000),  # via Diner (W)
    "Bay (C)": (-6937.226, 4752.155, 0.000),  # via Diner (W)
    "Bay (D)": (-6943.173, 4740.313, 0.000),  # via Diner (W)
    "Bay (E)": (-7474.898, 4646.636, 0.000),  # via Diner (W)
    "Bay (F)": (-7352.373, 4579.427, 0.000),  # via Diner (W)
    ...
    "Pelican Harbor Marina (A)": (1242.159, 1631.707, 0.000),  # via Venetian Islands
    "Pelican Harbor Marina (B)": (1041.151, 1685.662, 0.000),  # via Venetian Islands
    "Pelican Harbor Marina (C)": (1017.493, 1676.407, 0.000),  # via Venetian Islands
    ...
    #"Sunshine Skyway Bridge (N)": (-6651.500, 4560.344, 104.157),  # d=0.037 via Diner (W) & Ambrosia 04 (Fires)
